...
function cptpress_custom_posts_init() {
	...
	$profession_label = array(
		'name'                       => _x( 'Professions', 'Taxonomy Genres l Name', 'cptpress' ),
	...
	$category_label = array(
		'name'                       => _x( 'Portfolio Categories', 'Taxonomy Genres l Name', 'cptpress' ),
	...
	$case_study_category_label = array(
		'name'                       => _x( 'Case Study Categories', 'Taxonomy Genres l Name', 'cptpress' ),
	 ...
	 */
	$client_label = array(
		'name'                       => _x( 'Client Categories', 'Taxonomy Genres l Name', 'cptpress' ),
...
// Register the "FAQs" custom post type.
	...
	$book_labels = array(
		'name'                  => _x( 'Book', 'Post type general name', 'cptpress' ),
		'singular_name'         => _x( 'Book', 'Post type singular name', 'cptpress' ),
		'menu_name'             => _x( 'Book', 'Admin Menu text', 'cptpress' ),
		'name_admin_bar'        => _x( 'Book', 'Add New on Toolbar', 'cptpress' ),
		'add_new'               => __( 'Add New Book', 'cptpress' ),
		'add_new_item'          => __( 'Add New Book', 'cptpress' ),
		'new_item'              => __( 'New Book', 'cptpress' ),
		'edit_item'             => __( 'Edit Book', 'cptpress' ),
		'view_item'             => __( 'View Book', 'cptpress' ),
		'all_items'             => __( 'All Book', 'cptpress' ),
		'search_items'          => __( 'Search Book', 'cptpress' ),
		'parent_item_colon'     => __( 'Parent Book:', 'cptpress' ),
		'not_found'             => __( 'No Book found.', 'cptpress' ),
		'not_found_in_trash'    => __( 'No Book found in Trash.', 'cptpress' ),
		'featured_image'        => _x( 'Book Image', 'Overrides the "Featured Image", phrase for this post type. Added in 4.3', 'cptpress' ),
		'set_featured_image'    => _x( 'Set Book Image', 'Overrides the "Set featured image", phrase for this post type. Added in 4.3', 'cptpress' ),
		'remove_featured_image' => _x( 'Remove Book Image', 'Overrides the "Remove featured image" phrase for this post type. Added in 4.3', 'cptpress' ),
		'use_featured_image'    => _x( 'Use as Book Image', 'Overrides the "Use as featured image" phrase for this post type. Added in 4.3', 'cptpress' ),
		'archives'              => _x( 'Book archives', 'The post type archive label used in nav menus. Default "Post Archives". Added in 4.4', 'cptpress' ),
		'insert_into_item'      => _x( 'Insert into Book', 'Overrides the "Insert into post"/"Insert into page" phrase (used when inserting media into a post). Added in 4.4', 'cptpress' ),
		'uploaded_to_this_item' => _x( 'Uploaded to this Book', 'Overrides the "Uploaded to this post"/"Uploaded to this page" phrase (used when viewing media attached to a post). Added in 4.4', 'cptpress' ),
		'filter_items_list'     => _x( 'Filter Book list', 'Screen reader text for the filter links heading on the post type listing screen. Default "Filter posts list"/"Filter pages list". Added in 4.4', 'cptpress' ),
		'items_list_navigation' => _x( 'Book list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default "Posts list navigation"/"Pages list navigation". Added in 4.4', 'cptpress' ),
		'items_list'            => _x( 'Book list', 'Screen reader text for the items list heading on the post type listing screen. Default "Posts list"/"Pages list". Added in 4.4', 'cptpress' ),
	);

	$post_type_book = array(
		'labels'             => $book_labels,
		'public'             => true,
		'publicly_queryable' => true,
	...
	$book_option    = get_option( 'cptpress_options_book' );
	if ( ! empty( $book_option ) ) {
		register_post_type( 'book', $post_type_book );
		flush_rewrite_rules();
	}

	/**
	 * Register the "Book Genres " custom post type.
	 */
	$book_category_label = array(
		'name'                       => _x( 'Book Genres ', 'Taxonomy Genres l Name', 'cptpress' ),
		'singular_name'              => _x( 'Book Genres ', 'Taxonomy Singular Name', 'cptpress' ),
		'menu_name'                  => __( 'Book Genres ', 'cptpress' ),
		'all_items'                  => __( 'All Book Genres ', 'cptpress' ),
		'parent_item'                => __( 'Parent Book Genres ', 'cptpress' ),
		'parent_item_colon'          => __( 'Parent Book Genres :', 'cptpress' ),
		'new_item_name'              => __( 'New Book Genres  Name', 'cptpress' ),
		'add_new_item'               => __( 'Add New Book Genres ', 'cptpress' ),
		'edit_item'                  => __( 'Edit Book Genres ', 'cptpress' ),
		'update_item'                => __( 'Update Book Genres ', 'cptpress' ),
		'view_item'                  => __( 'View Book Genres ', 'cptpress' ),
		'separate_items_with_commas' => __( 'Separate Book Genres  with commas', 'cptpress' ),
		'add_or_remove_items'        => __( 'Add or remove Book Genres ', 'cptpress' ),
		'choose_from_most_used'      => __( 'Choose from the most used', 'cptpress' ),
		'popular_items'              => __( 'Popular Book Genres ', 'cptpress' ),
		'search_items'               => __( 'Search Book Genres ', 'cptpress' ),
		'not_found'                  => __( 'Not Found', 'cptpress' ),
		'no_terms'                   => __( 'No Book Genres ', 'cptpress' ),
		'items_list'                 => __( 'Book Genres  list', 'cptpress' ),
		'items_list_navigation'      => __( 'Book Genres  list navigation', 'cptpress' ),
	);

	$post_type_book_cat = array(
		'labels'            => $book_category_label,
		'hierarchical'      => true,
		'public'            => true,
		'show_ui'           => true,
		'show_admin_column' => true,
	...
	register_taxonomy( 'genera', array( 'book' ), $post_type_book_cat );
